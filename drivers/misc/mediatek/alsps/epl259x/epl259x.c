...
#define CUST_COMPATIABLE_NAME "mediatek,cust_epl259x"
...
static struct epl_sensor_priv *g_epl259x_ptr;
...
#if defined(__HCT_PS_EPL259X_DYNK_LOW_OFFSET__) &&(__HCT_PS_EPL259X_DYNK_LOW_OFFSET__>0)
    dynk_low_offset = __HCT_PS_EPL259X_DYNK_LOW_OFFSET__;	
    #else
    dynk_low_offset = 500;
#endif
#if defined(__HCT_PS_EPL259X_DYNK_HIGH_OFFSET__) &&(__HCT_PS_EPL259X_DYNK_HIGH_OFFSET__>0)
        dynk_high_offset = __HCT_PS_EPL259X_DYNK_HIGH_OFFSET__;
#else
...
static irqreturn_t epl_sensor_eint_func(int irq, void *desc)
{
    struct epl_sensor_priv *obj = g_epl259x_ptr;
...
{
    const char *name = CUST_COMPATIABLE_NAME;//"mediatek,cust_epl259x";
    APS_FUN();
