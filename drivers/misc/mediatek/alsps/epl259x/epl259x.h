...
#define EPL_ALS_RS_0			(0<<5)
#define EPL_ALS_RS_2			(1<<5)
#define EPL_ALS_RS_4			(2<<5)
#define EPL_ALS_RS_8			(3<<5)
#define EPL_ALS_RS_16			(4<<5)
#define EPL_ALS_RS_32			(5<<5)
#define EPL_ALS_RS_64		    (6<<5)
#define EPL_ALS_RS_128		    (7<<5)
