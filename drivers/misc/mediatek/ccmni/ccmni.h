...
typedef enum {
	...
	CCMNI_DBG_LEVEL_2 = (1<<1),
	CCMNI_DBG_LEVEL_TX = (1<<2),
	CCMNI_DBG_LEVEL_RX = (1<<3),
	CCMNI_DBG_LEVEL_ACK_SKB = (1<<4),
	CCMNI_DBG_LEVEL_TX_SKB = (1<<5),
	CCMNI_DBG_LEVEL_RX_SKB = (1<<6),
} CCMNI_DBG_LEVEL;
...
do { \
	...
	else if(ccmni_debug_level&CCMNI_DBG_LEVEL_2) \
