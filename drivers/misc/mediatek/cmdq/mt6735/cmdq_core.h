...
#define CMDQ_MAX_DUMPFIRSTERROR_COUNT	(16*1024)
typedef struct DumpFirstErrorStruct {
	...
	char cmdqStringBuffer[CMDQ_MAX_DUMPFIRSTERROR_COUNT];
	uint32_t cmdqCount;
	bool flag;
	struct timeval savetv;
} DumpFirstErrorStruct;
extern DumpFirstErrorStruct gCmdqDumpFirstError;
#endif
...
typedef enum CMDQ_INSTRUCTION_COUNT_ENUM {
	CMDQ_INSTRUCTION_COUNT_WRITE = 0,
	CMDQ_INSTRUCTION_COUNT_WRITE_W_MASK = 1,
	CMDQ_INSTRUCTION_COUNT_READ = 2,
	CMDQ_INSTRUCTION_COUNT_POLLING = 3,
	CMDQ_INSTRUCTION_COUNT_MOVE = 4,
	CMDQ_INSTRUCTION_COUNT_SYNC = 5,
	CMDQ_INSTRUCTION_COUNT_PREFETCH_ENABLE = 6,
	CMDQ_INSTRUCTION_COUNT_PREFETCH_DISABLE = 7,
	CMDQ_INSTRUCTION_COUNT_EOC = 8,
	CMDQ_INSTRUCTION_COUNT_JUMP = 9,

	CMDQ_INSTRUCTION_COUNT_MAX	/* ALWAYS keep at the end */
} CMDQ_INSTRUCTION_COUNT_ENUM;

typedef enum CMDQ_MODULE_INSTRUCTION_COUNT_ENUM {
	CMDQ_MODULE_INSTRUCTION_COUNT_MMSYS_CONFIG = 0,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_RDMA = 1,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_RSZ0 = 2,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_RSZ1 = 3,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_WDMA = 4,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_WROT = 5,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_TDSHP = 6,
	CMDQ_MODULE_INSTRUCTION_COUNT_MM_MUTEX = 7,
	CMDQ_MODULE_INSTRUCTION_COUNT_VENC = 8,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_OVL0 = 9,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_OVL1 = 10,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_RDMA0 = 11,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_RDMA1 = 12,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_WDMA0 = 13,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_COLOR = 14,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_CCORR = 15,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_AAL = 16,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_GAMMA = 17,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_DITHER = 18,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_UFOE = 19,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_PWM = 20,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_WDMA1 = 21,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_MUTEX = 22,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_DSI0 = 23,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_DPI0 = 24,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_OD = 25,
	CMDQ_MODULE_INSTRUCTION_COUNT_CAM0 = 26,
	CMDQ_MODULE_INSTRUCTION_COUNT_CAM1 = 27,
	CMDQ_MODULE_INSTRUCTION_COUNT_CAM2 = 28,
	CMDQ_MODULE_INSTRUCTION_COUNT_CAM3 = 29,
	CMDQ_MODULE_INSTRUCTION_COUNT_SODI = 30,
	CMDQ_MODULE_INSTRUCTION_COUNT_GPR = 31,
	CMDQ_MODULE_INSTRUCTION_COUNT_OTHERS = 32,
 
	CMDQ_MODULE_INSTRUCTION_COUNT_MAX	/* ALWAYS keep at the end */
} CMDQ_MODULE_INSTRUCTION_COUNT_ENUM;

typedef enum CMDQ_EVENT_INSTRUCTION_COUNT_ENUM {
	CMDQ_EVENT_INSTRUCTION_COUNT_HW = 0,
	CMDQ_EVENT_INSTRUCTION_COUNT_SW = 1,

	CMDQ_EVENT_INSTRUCTION_COUNT_MAX	/* ALWAYS keep at the end */
} CMDQ_EVENT_INSTRUCTION_COUNT_ENUM;

#define CMDQ_MAX_OTHERINSTRUCTION_COUNT		(16)

typedef struct CmdqModuleBasePA {
	long start[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	long end[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
} CmdqModuleBasePA;
#endif
...
typedef struct RecordStruct {
	...
	/* GCE instructions count information */
#ifdef CMDQ_INSTRUCTION_COUNT
	unsigned short instructionCount[CMDQ_INSTRUCTION_COUNT_MAX];
	unsigned short writeModule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	unsigned short writewmaskModule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	unsigned short readModlule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	unsigned short pollModule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	unsigned short eventCount[CMDQ_EVENT_INSTRUCTION_COUNT_MAX];
	uint32_t otherInstructions[CMDQ_MAX_OTHERINSTRUCTION_COUNT];
	uint32_t otherInstructionCount;
#endif
} RecordStruct;
 ...
 */
	...
	ssize_t cmdqCorePrintInstructionCountLevel(struct device *dev, struct device_attribute *attr,
		char *buf);
	ssize_t cmdqCoreWriteInstructionCountLevel(struct device *dev, struct device_attribute *attr,
		const char *buf, size_t size);
