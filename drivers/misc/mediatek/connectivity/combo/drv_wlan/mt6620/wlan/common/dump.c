		...
		if (u4Length >= 16) {
			...
			case 6:
				LOG_FUNC("(%08lx) %02x %02x %02x %02x  %02x %02x\n",
					 (UINT_32) pucStartAddr,
					 pucStartAddr[0], pucStartAddr[1], pucStartAddr[2],
					 pucStartAddr[3], pucStartAddr[4], pucStartAddr[5]);
				break;
			case 7:
			...
			case 8:
				LOG_FUNC("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x\n",
					 ...
					 pucStartAddr[0], pucStartAddr[1], pucStartAddr[2],
					 pucStartAddr[3], pucStartAddr[4], pucStartAddr[5],
					 pucStartAddr[6], pucStartAddr[7]);
				break;
			case 9:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
			...
			case 10:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
				     pucStartAddr[2], pucStartAddr[3], pucStartAddr[4],
				     pucStartAddr[5], pucStartAddr[6], pucStartAddr[7],
			...
			case 11:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
				     pucStartAddr[2], pucStartAddr[3], pucStartAddr[4],
				     pucStartAddr[5], pucStartAddr[6], pucStartAddr[7],
			...
			case 12:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
				     pucStartAddr[2], pucStartAddr[3], pucStartAddr[4],
				     pucStartAddr[5], pucStartAddr[6], pucStartAddr[7],
				     pucStartAddr[8], pucStartAddr[9], pucStartAddr[10],
			...
			case 13:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
				     pucStartAddr[2], pucStartAddr[3], pucStartAddr[4],
				     pucStartAddr[5], pucStartAddr[6], pucStartAddr[7],
				     pucStartAddr[8], pucStartAddr[9], pucStartAddr[10],
			...
			case 14:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
				     pucStartAddr[2], pucStartAddr[3], pucStartAddr[4],
				     pucStartAddr[5], pucStartAddr[6], pucStartAddr[7],
				     pucStartAddr[8], pucStartAddr[9], pucStartAddr[10],
			...
			case 15:
				LOG_FUNC
				    ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x %02x %02x\n",
				     (UINT_32) pucStartAddr, pucStartAddr[0], pucStartAddr[1],
				     pucStartAddr[2], pucStartAddr[3], pucStartAddr[4],
				     pucStartAddr[5], pucStartAddr[6], pucStartAddr[7],
				     pucStartAddr[8], pucStartAddr[9], pucStartAddr[10],
...
VOID dumpMemory32(IN PUINT_32 pu4StartAddr, IN UINT_32 u4Length)
{
	...
	if (IS_NOT_ALIGN_4((UINT_32) pu4StartAddr)) {
		...
		case 2:
			LOG_FUNC("(%08lx) %02x%02x----\n",
				 (UINT_32) pu4StartAddr, pucAddr[1], pucAddr[0]);
			break;
		case 3:
			LOG_FUNC("(%08lx) %02x%02x%02x--\n",
				 (UINT_32) pu4StartAddr, pucAddr[2], pucAddr[1], pucAddr[0]);
			break;
		default:
			break;
		}
	...
	while (u4Length > 0) {
		if (u4Length >= 16) {
			...
			case 4:
				LOG_FUNC("(%08lx) %08lx\n",
					 (UINT_32) pu4StartAddr, pu4StartAddr[0]);
				break;
			case 5:
				pucAddr = (PUINT_8) &pu4StartAddr[1];
				LOG_FUNC("(%08lx) %08lx ------%02x\n",
					 (UINT_32) pu4StartAddr, pu4StartAddr[0], pucAddr[0]);
				break;
			case 6:
				pucAddr = (PUINT_8) &pu4StartAddr[1];
			...
			case 8:
				LOG_FUNC("(%08lx) %08lx %08lx\n",
					 (UINT_32) pu4StartAddr, pu4StartAddr[0], pu4StartAddr[1]);
				break;
			case 9:
			...
			case 10:
				...
				LOG_FUNC("(%08lx) %08lx %08lx ----%02x%02x\n",
					 (UINT_32) pu4StartAddr,
					 pu4StartAddr[0], pu4StartAddr[1], pucAddr[1], pucAddr[0]);
				break;
			case 11:
				pucAddr = (PUINT_8) &pu4StartAddr[2];
