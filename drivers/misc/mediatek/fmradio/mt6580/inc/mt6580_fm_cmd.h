#ifndef __MT6580_FM_CMD_H__
#define __MT6580_FM_CMD_H__
...
fm_s32 mt6580_pwrup_fpga_on(fm_u8 *buf, fm_s32 buf_size);
...
fm_s32 mt6580_hwcoeff_download(fm_u8 *buf, fm_s32 buf_size, fm_u8 seg_num, fm_u8 seg_id,
			       const fm_u8 *src, fm_s32 seg_len);
fm_s32 mt6580_rom_download(fm_u8 *buf, fm_s32 buf_size, fm_u8 seg_num, fm_u8 seg_id,
			   const fm_u8 *src, fm_s32 seg_len);
#endif
