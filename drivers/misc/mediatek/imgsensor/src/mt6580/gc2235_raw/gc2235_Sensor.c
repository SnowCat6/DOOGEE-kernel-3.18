...
static imgsensor_info_struct imgsensor_info = {
    ...
    .cap1 = {                            //capture for PIP 24fps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
        ...
        .grabwindow_height = 1188,
        .mipi_data_lp2hs_settle_dc = 85,//unit , ns
        .max_framerate = 185,    //less than 13M(include 13M),cap1 max framerate is 24fps,16M max framerate is 20fps, 20M max framerate is 15fps
    },
    .normal_video = {
        .pclk = 24000000,
        .linelength = 1030,
    ...
    .max_frame_length = 8191,//max framelength by sensor register's limitation
    .ae_shut_delay_frame = 0,    //shutter delay frame for AE cycle, 2 frame with isp_gain_delay-shut_delay=2-0=2
    .ae_sensor_gain_delay_frame = 1,//sensor gain delay frame for AE cycle,2 frame with isp_gain_delay-sensor_gain_delay=2-0=2
...
{{ 1600, 1200,   0,   0, 1600, 1200, 1600, 1200, 0, 0, 1600, 1200,   8,   6, 1584, 1188}, // Preview
 ...
 { 1600, 1200,   0,   0, 1600, 1200, 1600, 1200, 0, 0, 1600, 1200,   8,   6, 1584, 1188}};//custom5
