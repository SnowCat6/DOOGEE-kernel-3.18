...
write_cmos_sensor(0x0345, 0x28); // x_addr_start_Lo (40, Display\BDÿ\A1 20-23 \C0\BA \C0߸\AE\B0\ED 24 \BA\CE\C5\CD \C3\E2\B7\C2)
write_cmos_sensor(0x0346, 0x00); // y_addr_start_Hi                                               
write_cmos_sensor(0x0347, 0x28); // y_addr_start_Lo (40, Display\BDÿ\A1 22-23 \C0\BA \C0߸\AE\B0\ED 24 \BA\CE\C5\CD \C3\E2\B7\C2)
write_cmos_sensor(0x0348, 0x0C); // x_addr_end_Hi                                                 
write_cmos_sensor(0x0349, 0xE7); // x_addr_end_Lo (3303, Display\BDÿ\A1 3320-3323 \C0\BA \C0߸\B2)           
write_cmos_sensor(0x034A, 0x09); // y_addr_end_Hi                                                 
write_cmos_sensor(0x034B, 0xB7); // y_addr_end_Lo (2487, Display\BDÿ\A1 2504-2505 \C0\BA \C0߸\B2)           
...
write_cmos_sensor(0x0345, 0xC8); // x_addr_start_Lo (40, Display\BDÿ\A1 20-23 \C0\BA \C0߸\AE\B0\ED 24 \BA\CE\C5\CD \C3\E2\B7\C2)
write_cmos_sensor(0x0346, 0x02); // y_addr_start_Hi                                               
write_cmos_sensor(0x0347, 0xD4); // y_addr_start_Lo (40, Display\BDÿ\A1 22-23 \C0\BA \C0߸\AE\B0\ED 24 \BA\CE\C5\CD \C3\E2\B7\C2)
write_cmos_sensor(0x0348, 0x0A); // x_addr_end_Hi                                                 
write_cmos_sensor(0x0349, 0x47); // x_addr_end_Lo (3303, Display\BDÿ\A1 3320-3323 \C0\BA \C0߸\B2)           
write_cmos_sensor(0x034A, 0x07); // y_addr_end_Hi                                                 
write_cmos_sensor(0x034B, 0x0B); // y_addr_end_Lo (2487, Display\BDÿ\A1 2504-2505 \C0\BA \C0߸\B2)           
