...
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,          //flip 180
	.mclk = 24,
	.mipi_lane_num = SENSOR_MIPI_4_LANE,
	.i2c_addr_table = {0x34,0x20, 0x6c, 0xff},
};
...
{/* Preview mode setting */
 {0x02, 0x0a, 0x00, 0x2b, 0x0838, 0x0618, 0x01, 0x35, 0x0200, 0x0001,
              0x02, 0x00, 0x0000, 0x0000, 0x03, 0x00, 0x0000, 0x0000},
 {0x02, 0x0a, 0x00, 0x2b, 0x1070, 0x0c30, 0x01, 0x35, 0x0200, 0x0001,
              0x02, 0x00, 0x0000, 0x0000, 0x03, 0x00, 0x0000, 0x0000},
 {0x02, 0x0a, 0x00, 0x2b, 0x1070, 0x0c30, 0x01, 0x35, 0x0200, 0x0001,
              0x02, 0x00, 0x0000, 0x0000, 0x03, 0x00, 0x0000, 0x0000}}; 
 typedef struct
 ...
 static SENSOR_ATR_INFO sensorATR_Info[3]=    
 {/* Strength Range Min */
...
static kal_uint32 imx215_ATR(UINT16 DarkLimit, UINT16 OverExp)
{
    LOG_INF("imx215_awb_gain\n");
...
//    write_cmos_sensor(0x0101,0x03);             //flip 180
}	/*	sensor_init  */
...
static kal_uint32 imx215_awb_gain(SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
    LOG_INF("imx215_awb_gain\n");
    ...
    LOG_INF("[imx215_awb_gain] ABS_GAIN_GR:%d, grgain_32:%d\n", pSetSensorAWB->ABS_GAIN_GR, grgain_32);
    LOG_INF("[imx215_awb_gain] ABS_GAIN_R:%d, rgain_32:%d\n", pSetSensorAWB->ABS_GAIN_R, rgain_32);
    LOG_INF("[imx215_awb_gain] ABS_GAIN_B:%d, bgain_32:%d\n", pSetSensorAWB->ABS_GAIN_B, bgain_32);
    LOG_INF("[imx215_awb_gain] ABS_GAIN_GB:%d, gbgain_32:%d\n", pSetSensorAWB->ABS_GAIN_GB, gbgain_32);
...
//UINT32 IMX215_MIPI_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
