 ...
 ****************************************************************************/
  ...
  #define S5K4E2GX_MIPI_RAW_MAIN_2_USE_HW_I2C
...
#include "s5k4e2gx_mipi_raw_Sensor.h"
...
MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT S5K4ECGX_PreviewWin[5];
...
static kal_uint16 S5K4ECGX_table_write_cmos_sensor(const kal_uint16* para, kal_uint32 len)
{
...
*
*************************************************************************/
static void S5K4ECGX_MIPI_GetCurAeAwbInfo(uintptr_t Info)
{
...
static void S5K4ECGX_MIPI_AE_Get_Status(UINT32 *pFeatureReturnPara32)
{
    ...
    else if(S5K4ECGX_Driver.userAskAeLock)
    {
...
static void S5K4ECGX_MIPI_AWB_Get_Status(UINT32 *pFeatureReturnPara32)
{
    ...
    else if(S5K4ECGX_Driver.userAskAwbLock)
    {
...
void S5K4ECGX_MIPI_get_AEAWB_lock(uintptr_t pAElockRet32, uintptr_t pAWBlockRet32)
{
 //   *pAElockRet32 = 1;
 //   *pAWBlockRet32 = 1;
