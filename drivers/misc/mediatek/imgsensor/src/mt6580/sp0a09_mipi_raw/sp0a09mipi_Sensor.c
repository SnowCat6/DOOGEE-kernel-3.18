	  ...
	  kal_uint8  iReg;
   	 ...
   	 {   
            ...
            //   iReg+= (gain%BASEGAIN)/(0x10/BASEGAIN);
   	    	 ...
   	    	 {
   	    	    	 write_cmos_sensor(0xfd, 0x00);
   	    	    	 write_cmos_sensor(0x24, 0x28);//0x23
   	    	    	 write_cmos_sensor(0x01, 0x01);
...
static void sensor_init(void)
{
  ...
  write_cmos_sensor(0x6c,0x11);  
  write_cmos_sensor(0x6d,0x00);  
  write_cmos_sensor(0x6f,0x12);  
  write_cmos_sensor(0x6e,0x13);  
  ...
  write_cmos_sensor(0xcd,0x0c);  
  write_cmos_sensor(0xa4,0x01);  
  write_cmos_sensor(0x24,0x28);
  write_cmos_sensor(0x03,0x01);
  write_cmos_sensor(0x04,0xc2);
