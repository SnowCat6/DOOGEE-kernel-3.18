...
static void GC2035_Sensor_Init(void)
{
	...
	#if defined(N539_PROJ)||defined(N539AA_PROJ) || defined(K45_PROJ)//liwei,2012.12.26
	...
	GC2035_write_cmos_sensor(0x84 , 0xa3); //output put foramat//01
	...
	//////lsc/////////////
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0xc2 , 0x1f);
	GC2035_write_cmos_sensor(0xc3 , 0x12);
	GC2035_write_cmos_sensor(0xc4 , 0x0b);
	GC2035_write_cmos_sensor(0xc8 , 0x0d);
	GC2035_write_cmos_sensor(0xc9 , 0x08);
	GC2035_write_cmos_sensor(0xca , 0x02);
	GC2035_write_cmos_sensor(0xbc , 0x2a);
	GC2035_write_cmos_sensor(0xbd , 0x12);
	GC2035_write_cmos_sensor(0xbe , 0x10);
	GC2035_write_cmos_sensor(0xb6 , 0x2b);
	GC2035_write_cmos_sensor(0xb7 , 0x1f);
	GC2035_write_cmos_sensor(0xb8 , 0x08);
	...
	GC2035_write_cmos_sensor(0xb9 , 0x01);
	GC2035_write_cmos_sensor(0xba , 0x00);
	GC2035_write_cmos_sensor(0xbb , 0x13);
	GC2035_write_cmos_sensor(0xaa , 0x06);
	GC2035_write_cmos_sensor(0xab , 0x0a);
	GC2035_write_cmos_sensor(0xac , 0x07);
	GC2035_write_cmos_sensor(0xad , 0x19);
	GC2035_write_cmos_sensor(0xae , 0x10);
	GC2035_write_cmos_sensor(0xaf , 0x14);
	...
	GC2035_write_cmos_sensor(0xd3 , 0x1d);
	GC2035_write_cmos_sensor(0xd8 , 0x00);
	GC2035_write_cmos_sensor(0xda , 0x13);
	GC2035_write_cmos_sensor(0xdb , 0x16);
	GC2035_write_cmos_sensor(0xdc , 0x00);
	GC2035_write_cmos_sensor(0xde , 0x19);
	GC2035_write_cmos_sensor(0xdf , 0x23);
	GC2035_write_cmos_sensor(0xd4 , 0x00);
	GC2035_write_cmos_sensor(0xd6 , 0x0d);
	GC2035_write_cmos_sensor(0xd7 , 0x2a);
...
//xy2023
	...
	GC2035_write_cmos_sensor(0x4e , 0x80);
	GC2035_write_cmos_sensor(0x4d , 0x44);
	...
	GC2035_write_cmos_sensor(0x4d , 0x70);
	GC2035_write_cmos_sensor(0x4e , 0x00);
...
//xy2012
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x3c);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x3c);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x44);//contrast ?	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfc);//luma_offset 
...
UINT32 GC2035GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	pSensorResolution->SensorVideoWidth=GC2035_IMAGE_SENSOR_PV_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x90);//80
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_13:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0xd0);
			GC2035_SET_PAGE0;
		break;
		default:
		return FALSE;
