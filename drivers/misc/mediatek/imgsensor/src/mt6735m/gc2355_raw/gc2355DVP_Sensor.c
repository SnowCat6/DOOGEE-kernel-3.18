...
static imgsensor_info_struct imgsensor_info = {
   ...
   // .mipi_sensor_type = MIPI_OPHY_NCSI2, //0,MIPI_OPHY_NCSI2;  1,MIPI_OPHY_CSI2
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW8_R,//sensor output first pixel color 
...
write_cmos_sensor(0xf8 , 0x06); //06 travis
write_cmos_sensor(0xf9 , 0x4e);  
write_cmos_sensor(0xfa , 0x00);  //00
...
write_cmos_sensor(0xfe , 0x00);  
	...
	//////////////////      ANAL& CISCTL      ///////////////
	//////////////////////////////////////////////////
write_cmos_sensor(0x03 , 0x07);  //07 travis
...
write_cmos_sensor(0x24 , 0x1b);  //1b 
...
write_cmos_sensor(0xb6 , 0x00);  
	...
	///////////////////////    crop     //////////////////////
	//////////////////////////////////////////////////
write_cmos_sensor(0x92 , 0x02);//01 travis	  
write_cmos_sensor(0x94 , 0x06);//05 travis 
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->SensorHsyncPolarity = SENSOR_CLOCK_POLARITY_LOW; // inverse with datasheet  //LOW
