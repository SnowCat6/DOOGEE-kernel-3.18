...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre_delay_frame = 6,         //enter preview delay frame num
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xe4,0x00);
	write_cmos_sensor(0xe5,0x01);
	write_cmos_sensor(0xe6,0x00);
	write_cmos_sensor(0xe7,0x01);
	...
	write_cmos_sensor(0x9e,0x04);
	write_cmos_sensor(0x9f,0x04);
	write_cmos_sensor(0xa0,0x05);
	write_cmos_sensor(0xa1,0x0e);
	write_cmos_sensor(0xb8,0x03);
	write_cmos_sensor(0xb9,0x04);
	write_cmos_sensor(0xba,0x04);
	write_cmos_sensor(0xbb,0x04);
	write_cmos_sensor(0xbc,0x04);
	write_cmos_sensor(0xbd,0x05);
	write_cmos_sensor(0xbe,0x0e);
	...
	write_cmos_sensor(0x04,0x04);//04
