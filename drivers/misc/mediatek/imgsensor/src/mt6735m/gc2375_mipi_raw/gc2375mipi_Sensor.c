...
//		write_cmos_sensor(0x87,0x00);
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375MIPI analogic gain 1.375x , GC2375MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_3<= iReg)&&(iReg < ANALOG_GAIN_4))
	{
		write_cmos_sensor(0xd8,0x60);
//		write_cmos_sensor(0x87,0xfe);
		//analog gain
		write_cmos_sensor(0xb6,0x02);
		temp = 64*iReg/ANALOG_GAIN_3;
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375MIPI analogic gain 1.891x , GC2375MIPI add pregain = %d\n",temp);
	}
...
//		write_cmos_sensor(0x87,0xfe);
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375MIPI analogic gain 2.625x , GC2375MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_5<= iReg)&&(iReg < ANALOG_GAIN_6))
	{
		write_cmos_sensor(0xd8,0x80);
//		write_cmos_sensor(0x87,0xfd);
		//analog gain
		write_cmos_sensor(0xb6,0x04);
		temp = 64*iReg/ANALOG_GAIN_5;
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375MIPI analogic gain 3.734x , GC2375MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_6<= iReg)&&(iReg < ANALOG_GAIN_7))
	{
		write_cmos_sensor(0xd8,0x80);
//		write_cmos_sensor(0x87,0xfc);
		//analog gain
		write_cmos_sensor(0xb6,0x05);
		temp = 64*iReg/ANALOG_GAIN_6;
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375MIPI analogic gain 5.250x , GC2375MIPI add pregain = %d\n",temp);
	}	
...
//		write_cmos_sensor(0x87,0xfa);
	...
	{
		write_cmos_sensor(0xd8,0xb0);
//		write_cmos_sensor(0x87,0xf8);
		//analog gain
...
//		write_cmos_sensor(0x87,0xf8);
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375MIPI analogic gain 7.516x , GC2375MIPI add pregain = %d\n",temp);
	}
	return gain;
...
//	write_cmos_sensor(0x19,0x0f); //0x15	
	...
	write_cmos_sensor(0xd8,0x60);
	write_cmos_sensor(0xe0,0x08);//00
	write_cmos_sensor(0xe1,0x1f); //[3:0]post_tx_width
	write_cmos_sensor(0xe4,0xf8);
	write_cmos_sensor(0xe5,0x0c); //[7:6]init_pxd_mode
	write_cmos_sensor(0xe6,0x10); //ramps_offset
	write_cmos_sensor(0xe7,0xcc); //[7:6]Wen
	...
	write_cmos_sensor(0x41,0x00);//81
	write_cmos_sensor(0x42,0x80);//80	
	write_cmos_sensor(0x4a,0x00);//81	
	write_cmos_sensor(0x4e,0x0f);
	write_cmos_sensor(0x4f,0xf0);//30
//	write_cmos_sensor(0x60,0x00);
//	write_cmos_sensor(0x61,0x80);
#else if 	
	write_cmos_sensor(0x18,0x0a);
	write_cmos_sensor(0x1a,0x1c);
	write_cmos_sensor(0x28,0x10);

	write_cmos_sensor(0x40,0x27);
	write_cmos_sensor(0x41,0x01);//81
	write_cmos_sensor(0x42,0x00);//80	

	write_cmos_sensor(0x4a,0x89);//81
	write_cmos_sensor(0x4e,0x66);
	write_cmos_sensor(0x4f,0x0c);//30

#endif
	write_cmos_sensor(0x3f,0x10);
	write_cmos_sensor(0x43,0x0f);
	write_cmos_sensor(0x66,0x88);//11
	write_cmos_sensor(0x67,0xc0);//03

	write_cmos_sensor(0xfe,0x01);
	write_cmos_sensor(0x41,0x44);
	write_cmos_sensor(0x42,0x47);
	write_cmos_sensor(0x43,0x5b);
	write_cmos_sensor(0x44,0x58);
	write_cmos_sensor(0xfe,0x00);


	/*Dark sun*/                                      
	write_cmos_sensor(0x68,0x00); // Digital darksun_en	
...
UINT32 GC2375_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
