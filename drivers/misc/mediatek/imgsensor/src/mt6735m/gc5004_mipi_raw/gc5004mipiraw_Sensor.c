...
#define LOG_1 LOG_INF("GC5004,MIPI 2LANE\n")
...
#define GC5004MIPI_DRIVER_TRACE
#define SENSORDB(x,...)
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC5004MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xf7, 0x1d); //Pll enable
	...
	//////////////////////   BLK   //////////////////////
	/////////////////////////////////////////////////////
	write_cmos_sensor(0x40, 0x22);  //72 tao 9.28
	...
	write_cmos_sensor(0x80, 0x18); //[4]first_dd_en;[3]scaler en
	write_cmos_sensor(0x84, 0x23); //[5]auto_DD,[1:0]scaler CFA
	...
	write_cmos_sensor(0x15, 0x10); //0x12 20140722
	write_cmos_sensor(0x17, 0xb0);
	...
	write_cmos_sensor(0x10, 0x81); // 0x93  20140722
	write_cmos_sensor(0xfe, 0x00);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x05, 0x03); //HB
	write_cmos_sensor(0x06, 0x26); 
	write_cmos_sensor(0x09, 0x00);
	write_cmos_sensor(0x0a, 0x02); //row start
	write_cmos_sensor(0x0b, 0x00);
	write_cmos_sensor(0x0c, 0x00); //col start
