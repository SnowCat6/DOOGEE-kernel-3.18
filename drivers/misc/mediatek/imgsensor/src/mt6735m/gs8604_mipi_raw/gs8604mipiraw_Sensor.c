...
#include "gs8604mipiraw_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "gs8604_camera_sensor"
#define LOG_1 LOG_INF("gs8604,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = GS8604MIPI_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
kal_uint16 GS8604MIPI_sensorGainMapping[GS8604MIPI_MaxGainIndex][2] ={
{ 64 ,0  },   
{ 68 ,12 },   
{ 71 ,23 },   
{ 74 ,33 },   
...
{
	kal_uint8 iI;
    LOG_INF("[GS8604MIPI]enter GS8604MIPIGain2Reg function\n");
    for (iI = 0; iI < (GS8604MIPI_MaxGainIndex-1); iI++) 
	{

        if(gain <GS8604MIPI_sensorGainMapping[iI][0])
		{    
            break;
        }
		if(gain < GS8604MIPI_sensorGainMapping[iI][0])
    ...
    if(gain != GS8604MIPI_sensorGainMapping[iI][0])
    {
         LOG_INF("Gain mapping don't correctly:%d %d \n", gain, GS8604MIPI_sensorGainMapping[iI][0]);
    }
	LOG_INF("exit GS8604MIPIGain2Reg function\n");
...
UINT32 GS8604_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
