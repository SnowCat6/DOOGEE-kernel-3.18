...
#include "imx149mipiraw_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "imx149_camera_sensor"

#define LOG_1 LOG_INF("IMX149,MIPI 2LANE\n")
...
{{ 3280, 2464,	 0,	0, 3280, 2464, 1640,  1232, 0000, 0000, 1640, 1232,	  2,	2, 1632,  1224}, // Preview 
 ...
 { 3280, 2464,	 0, 0, 3280, 2464, 1640,  1232, 0000, 0000, 1640, 1232,	  2,	2, 1632,  1224}, //hight speed video 
 { 3280, 2464,	 0, 0, 3280, 2464, 1640,  1232, 0000, 0000, 1640, 1232,	  2,	2, 1632,  1224},// slim video 
 };// slim video  
...
{
	LOG_INF("E\n");
		LOG_INF("[IMX149MIPI]enter IMX149MIPI_Sensor_Init function\n");
...
static void preview_setting(void)
{
	...
	LOG_INF("[IMX149MIPI]enter PreviewSetting function\n");
	write_cmos_sensor(0x41C0, 0x01);
	write_cmos_sensor(0x0104, 0x01);//group
	write_cmos_sensor(0x0100, 0x00);//STREAM OFF 	
	//write_cmos_sensor(0x0103, 0x01);//SW reset
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 240) 
	{
		LOG_INF("[IMX149MIPI]enter IMX149MIPI_set_8M function\n");
	write_cmos_sensor(0x41C0, 0x01);         
...
{		
	...
	LOG_INF("[IMX149MIPI]enter VideoFullSizeSetting function\n");
	write_cmos_sensor(0x41C0, 0x01); 		
	write_cmos_sensor(0x0100, 0x00); 		 
	write_cmos_sensor(0x0101, 0x00); 		
	write_cmos_sensor(0x030E, 0x0C); 		 
	...
	write_cmos_sensor(0x4109, 0x7C);  
	write_cmos_sensor(0x0100, 0x01);//STREAM ON
	LOG_INF("[IMX149MIPI]exit VideoFullSizeSetting function\n"); 
}
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
	LOG_INF("[IMX149MIPI] exit IMX149MIPISetTestPatternMode function \n");
    return ERROR_NONE;
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
            *sensor_id = return_sensor_id();
			if (*sensor_id <= imgsensor_info.sensor_id+6) {				
