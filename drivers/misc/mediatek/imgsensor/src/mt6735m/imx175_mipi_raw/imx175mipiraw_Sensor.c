...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//SENSOR_OUTPUT_FORMAT_RAW_R
	.mclk = 26,
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor(0x3368, 0x18); 		 
	write_cmos_sensor(0x3369, 0x00); 		 
	write_cmos_sensor(0x3370, 0x77);
	write_cmos_sensor(0x3371, 0x2F);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x3368, 0x18); 		 
	write_cmos_sensor(0x3369, 0x00); 		 
	write_cmos_sensor(0x3370, 0x67);
	write_cmos_sensor(0x3371, 0x17);
