...
#include "ov5675submipi_Sensor.h"

#define PFX "ov5675sub_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV5675SUBMIPI_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
{
	LOG_INF("OV5675SUB_Sensor_Init_2lane E\n");
	//OV5675R1A_AM01d 
...
UINT32 OV5675SUB_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	OV5675SUB_MIPI_RAW_SensorInit	*/
