...
#if 1
    kal_uint8 sensor_clock_polarity;
    kal_uint8 sensor_hsync_polarity;
    kal_uint8 sensor_vsync_polarity;
      
    kal_uint16 sensor_pre_res_x;
    kal_uint16 sensor_pre_res_y;
    kal_uint16 sensor_full_res_x;
    kal_uint16 sensor_full_res_y;
    kal_uint8 sensor_preview_fps;
    kal_uint8 sensor_video_fps;
    kal_uint8 sensor_still_cap_fps;
    kal_uint8 sensor_webcam_cap_fps;
#endif
