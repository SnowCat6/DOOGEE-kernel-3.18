...
#include "sp2509submipi_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = SP2509SUBMIPI_SENSOR_ID,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if(enable)
       // write_cmos_sensor0(0x503D, 0x80); //whl131120 remove
       write_cmos_sensor0(0xfd, 0x00);
    else
        //write_cmos_sensor0(0x503D, 0x00);  //whl131120 remove
        write_cmos_sensor0(0xfd, 0x00); 
