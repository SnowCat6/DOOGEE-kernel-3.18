...
static void lcm_init(void)
{
    ...
    if(ret)    	
    dprintf(0, "[LK]hx8394----tps6132----cmd=%0x--i2c write error----\n",cmd);    	
	else
	dprintf(0, "[LK]hx8394----tps6132----cmd=%0x--i2c write success----\n",cmd);    		
#else
	ret=tps65132_write_bytes(cmd,data);
	if(ret<0)
	printk("[KERNEL]hx8394----tps6132---cmd=%0x-- i2c write error-----\n",cmd);
	else
	printk("[KERNEL]hx8394----tps6132---cmd=%0x-- i2c write success-----\n",cmd);
#endif
