...
static MINT32 ISP_DumpReg(void)
{
	...
	RegDump(0xe00, 0xe30);
	/* Mipi	source */
	LOG_DBG("[0x%08X %08X],[0x%08X %08X]", (unsigned int)(0x10215830), (unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0x830),
		(unsigned int)(0x10215830),	(unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0x830));
	LOG_DBG("[0x%08X %08X],[0x%08X %08X]", (unsigned int)(0x10215c30), (unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0xc30),
