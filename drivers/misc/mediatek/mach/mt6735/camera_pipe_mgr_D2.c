...
//#include <asm/io.h>
#include <mach/camera_pipe_mgr_D2.h>
#include <mach/camera_pipe_mgr_imp_D2.h>
//
#ifdef CONFIG_COMPAT
//64 bit
#include <linux/fs.h>
        ...
        case COMPAT_CAM_PIPE_MGR_LOCK:     //
            {
                ...
                ret = filp->f_op->unlocked_ioctl(filp, CAM_PIPE_MGR_LOCK,(unsigned long)data);
        ...
        case COMPAT_CAM_PIPE_MGR_UNLOCK:     //
            {
                ...
                ret = filp->f_op->unlocked_ioctl(filp, CAM_PIPE_MGR_UNLOCK,(unsigned long)data);
        ...
        case COMPAT_CAM_PIPE_MGR_SET_MODE:     //
            {
                ...
                ret = filp->f_op->unlocked_ioctl(filp, CAM_PIPE_MGR_SET_MODE,(unsigned long)data);
        ...
        case COMPAT_CAM_PIPE_MGR_GET_MODE:     //
            {
                ...
                ret = filp->f_op->unlocked_ioctl(filp, CAM_PIPE_MGR_GET_MODE,(unsigned long)data);
                err = compat_put_campipe_mode_data(data32, data);
                if (err)
                {
                    LOG_MSG("compat_put_sysram_alloc_data error!!!\n");
        ...
        case COMPAT_CAM_PIPE_MGR_ENABLE_PIPE:     //
            {
                ...
                ret = filp->f_op->unlocked_ioctl(filp, CAM_PIPE_MGR_ENABLE_PIPE,(unsigned long)data);
        ...
        case COMPAT_CAM_PIPE_MGR_DISABLE_PIPE:     //
            {
                ...
                ret = filp->f_op->unlocked_ioctl(filp, CAM_PIPE_MGR_DISABLE_PIPE,(unsigned long)data);
...
//-----------------------------------------------------------------------------
static MINT32 CamPipeMgr_Probe(struct platform_device *pDev)
{
    MINT32 Ret = 0;
    MUINT32 i;
