...
enum
{
    ...
    MST_ID_APMCU_11,MST_ID_APMCU_12,MST_ID_APMCU_13,MST_ID_APMCU_14,
    ...
    /* Modem HW (2G/3G) */
    MST_ID_MDHW_0,MST_ID_MDHW_1,MST_ID_MDHW_2,MST_ID_MDHW_3,MST_ID_MDHW_4,MST_ID_MDHW_5,
    MST_ID_MDHW_6,MST_ID_MDHW_7,MST_ID_MDHW_8,MST_ID_MDHW_9,
...
#define SET_ACCESS_PERMISSON(d7, d6, d5, d4, d3, d2, d1, d0) ((((d3) << 9) | ((d2) << 6) | ((d1) << 3) | (d0)) | ((((d7) << 9) | ((d6) << 6) | ((d5) << 3) | (d4)) << 16))
#else //MT6735M
