...
static int __init mt_clkmgr_late_init(void)
{
    ...
    //mt_enable_clock(MT_CG_VENC_LARB, "clkmgr");  //D2 no VENC
    //mt_disable_clock(MT_CG_VENC_LARB, "clkmgr"); //D2 no VENC
