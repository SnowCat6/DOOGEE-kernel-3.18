...
extern unsigned int *copy_words(volatile unsigned *destination,
...
static void save_gic_interface(u32 * pointer,
			       unsigned int gic_interface_address)
{
...
static void save_gic_distributor_private(u32 * pointer,
					 unsigned int gic_distributor_address)
{
...
static void restore_gic_spm_irq(unsigned int gic_distributor_address)
{
	interrupt_distributor *id =
	    (interrupt_distributor *) gic_distributor_address;
	unsigned int backup;
