...
/* Vanzo:zhangqingzhan on: Mon, 26 Dec 2016 14:32:32 +0800
 * fix bug #126376
  ncp1854_set_ieoc(0x6); // cut off current = 100mA
 */
  ncp1854_set_ieoc(0x0); /* cut off current = 250mA */
...
/* Vanzo:yangbinbin on: Mon, 17 Oct 2016 12:25:34 +0800
