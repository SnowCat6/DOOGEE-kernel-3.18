...
static int epl2182_ps_factory_set_threashold(int32_t threshold[2])
{
	int err = 0;
	struct epl2182_priv *obj = epl2182_obj;
...
static int epl2182_ps_factory_get_threashold(int32_t threshold[2])
{
	struct epl2182_priv *obj = epl2182_obj;
...
static struct alsps_factory_fops epl2182_factory_fops = {
	...
	.ps_set_threashold = epl2182_ps_factory_set_threashold,
	.ps_get_threashold = epl2182_ps_factory_get_threashold,
};
