...
#if VDEC_UFO_SUPPORT
    printk("MC_664 write == 0x00000010\n");
...
BOOL bVDEC_HAL_H264_SetBRefRegforUFO(UINT32 u4VDecID, VDEC_INFO_H264_B_REF_PRM_T *prBRefPicListInfo, BOOL bForB0, BOOL bForB1)
{
    ...
    printk("bVDEC_HAL_H264_SetBRefRegforUFO in\n");
    ...
    if (bB0B1Both == TRUE)
    {
        ...
        {
            printk("%d (%d %d)\n", ucRegIdx, prBRefPicListInfo->i4TFldPOC1, prBRefPicListInfo->i4BFldPOC1);
            u4RegValue = u4VDecReadMC(u4VDecID, 664 * 4);
            printk("MC_664 read == 0x%08x\n", u4RegValue);
            vVDecWriteMC(u4VDecID, 664 * 4, u4RegValue | 0x010);
            printk("MC_664 write == 0x%08x\n", u4RegValue | 0x010);
            ...
            printk("MC_720 read == 0x%08x\n", u4RegValue);
            vVDecWriteMC(u4VDecID, 720 * 4, u4RegValue | (0x01 << ucRegIdx));
            printk("MC_720 write == 0x%08x (%d) \n", u4RegValue | (0x01 << ucRegIdx), prBRefPicListInfo->i4PicNum1);
    ...
    printk("bVDEC_HAL_H264_SetBRefRegforUFO out\n");
#if 0
    /*
    else {
        /u4RegValue = u4VDecReadMC(u4VDecID, 719 * 4);
...
{
    UINT32 u4Temp;
    printk("vVDEC_HAL_H264_B1ListSwap\n");
