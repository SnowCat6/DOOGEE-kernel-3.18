...
#else
#ifdef VDEC_VP8_VERFIY_CODE
//#define GOLD_Y_SZ  0x1A00000//(4096*4096)
//#define GOLD_C_SZ  0xD00000 //(4096*4096)/2  //1920x1080
#define GOLD_Y_SZ  0x1000000//(4096*4096)
#define GOLD_C_SZ  0x800000//(4096*4096)/2
#else
#define GOLD_Y_SZ  0x1A00000//(4096*4096)
#define GOLD_C_SZ  0xD00000 //(4096*4096)/2  //1920x1080
#endif
#endif
#else
#define GOLD_Y_SZ  4096*2176*5/4 //(4096*2160) 10bits
#define GOLD_C_SZ  4096*2176/2*5/4  //(4096*2160)/2 10bits
#endif
...
#if VDEC_VP8_WRAPPER_OFF
#ifdef VDEC_VP8_VERFIY_CODE
#define V_FIFO_SZ 0x4100000//0x01900000 //0x0800000
#else
#define V_FIFO_SZ 0x0800000 //0x0800000
#endif
#else
#ifdef VDEC_VP8_VERFIY_CODE
#define V_FIFO_SZ 0x4100000//0x01900000//0x06400000//0x05000000 //0x1000000
#else
#define V_FIFO_SZ 0x04000000//0x05000000 //0x1000000    //HEVC
#endif
#endif
...
#ifdef VDEC_VP8_VERFIY_CODE
/* Used for 6593 seg_id data copy (dram <-> sram) */
#define SEG_ID_SZ 256*1024
#define SEG_I_SA V_PRED_SA + VLD_PRED_SZ
#endif
...
#define PIC_Y_SZ          0x1000000//(4096*4096)
#define PIC_C_SZ          0x800000//(4096*4096)/2
#else
#define PIC_Y_SZ          0x1A00000//(4096*4096) //(2048*1088) *2
#define PIC_C_SZ          0xD00000//(4096*4096)/2 // (2048*1088 / 2) *2
#endif
...
#else
#ifdef VDEC_VP8_VERFIY_CODE
#define PIC_Y_SZ          (3840*2160) *2//(2048*1088) *2
#define PIC_C_SZ          (3840*2160 / 2) *2//(2048*1088 / 2) *2
#else
...
// ~WMV PP Work Bufer
#ifdef VDEC_VP8_VERFIY_CODE
#define DEC_PP_Y_SZ      (3840*2160) *2//(2048*1088) *2
#define DEC_PP_C_SZ      (3840*2160 / 2) *2//(2048*1088/2) *2
#else
...
extern int m4u_v2p(unsigned long va);
