...
ULONG  VA_VDEC_BASE;
ULONG  VA_VDEC_GCON_BASE;

#if defined(VDEC_VP8_VERIFY_CODE) || defined(WMV_UFO_ENABLE)
#if VDEC_UFO_SUPPORT
UINT32 u4PIC_WIDTH[2], u4PIC_HEIGHT[2];
UINT32 u4PIC_SIZE_Y[2], u4PIC_SIZE[2];
UINT32 u4UFO_LEN_SIZE_Y[2], u4UFO_LEN_SIZE_C[2];
UINT32 u4PIC_SIZE_Y_BS[2], u4PIC_SIZE_BS[2], u4PIC_SIZE_REF[2];
...
UCHAR *_pucFAKE[2];  //@ For fake engine test
...
#if VDEC_UFO_SUPPORT
//UFO
UINT32  u4PIC_WIDTH[2];
UINT32  u4PIC_HEIGHT[2];
UINT32  u4PIC_SIZE_Y[2];
UINT32  u4PIC_SIZE[2];
UINT32  u4UFO_LEN_SIZE_Y[2];
UINT32  u4UFO_LEN_SIZE_C[2];
UINT32  u4PIC_SIZE_Y_BS[2];
UINT32  u4PIC_SIZE_BS[2];
UINT32  u4PIC_SIZE_REF[2];
#endif
...
// H265 Struct
VDEC_INFO_H265_FBUF_INFO_T _ptH265FBufInfo[2][25];
VDEC_INFO_H265_FBUF_INFO_T *_ptH265CurrFBufInfo[2];
VDEC_INFO_H265_REF_PIC_LIST_T _ptH265RefPicList[2];
H265_SPS_Data _rH265SPS[2][32];
H265_PPS_Data _rH265PPS[2][256];
H265_Slice_Hdr_Data _rH265SliceHdr[2];
H265_SEI_Data _rH265SEI[2];
VDEC_INFO_H265_PIC_INFO_T _rH265PicInfo[2];
// ~H265 Struct
...
UCHAR _u4NuhLayerId[2];
UCHAR _u4NuhTemporalId[2];
...
char _bESAStr1[2][200] = {" ,NBM_DLE_NUM,ESA_REQ_DATA_NUM,MC_REQ_DATA_NUM,MC_MBX,MC_MBY,CYC_SYS,INTRA_CNT,LAT_BUF_BYPASS,Y_BLK_CNT,C_BLK_CNT,WAIT_CNT,REQ_CNT,MC_DLE_NUM,CYCLE_DRAM,\0",
                          " ,NBM_DLE_NUM,ESA_REQ_DATA_NUM,MC_REQ_DATA_NUM,MC_MBX,MC_MBY,CYC_SYS,INTRA_CNT,LAT_BUF_BYPASS,Y_BLK_CNT,C_BLK_CNT,WAIT_CNT,REQ_CNT,MC_DLE_NUM,CYCLE_DRAM,\0"
                         };
#else
...
#else
#ifdef VDEC_VP8_VERIFY_CODE
char _ESAFileName[2][100] = {"D:\\FPGA_VDEC_VP8\\ESA_LOG.csv\0", "D:\\FPGA_VDEC_VP8\\ESA_LOG1.csv\0"};
#else
...
#else
#ifdef VDEC_VP8_VERIFY_CODE
char _FileList[2][100] = {"D:\\FPGA_VDEC_VP8\\vp8_list.txt\0", "D:\\FPGA_VDEC_VP8\\vp8_list.txt\0"};
#else
char _FileList[2][100] = {"/data/H264/list.txt", "/data/H264/list.txt"};
#endif
#endif
