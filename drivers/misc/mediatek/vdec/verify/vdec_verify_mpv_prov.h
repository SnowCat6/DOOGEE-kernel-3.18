...
extern UCHAR *_pucFAKE[2];  //@ For fake engine test
...
#if VDEC_UFO_SUPPORT
extern UINT32 u4PIC_WIDTH[2], u4PIC_HEIGHT[2];
extern UINT32 u4PIC_SIZE_Y[2], u4PIC_SIZE[2];
extern UINT32 u4UFO_LEN_SIZE_Y[2], u4UFO_LEN_SIZE_C[2];
extern UINT32 u4PIC_SIZE_Y_BS[2], u4PIC_SIZE_BS[2], u4PIC_SIZE_REF[2];
extern UINT32 u4DramPicSize, u4DramPicArea;
#endif
...
extern UCHAR _u4NuhLayerId[2];
extern UCHAR _u4NuhTemporalId[2];
...
// H265 Struct
extern VDEC_INFO_H265_FBUF_INFO_T _ptH265FBufInfo[2][25];
extern VDEC_INFO_H265_FBUF_INFO_T *_ptH265CurrFBufInfo[2];
extern VDEC_INFO_H265_REF_PIC_LIST_T _ptH265RefPicList[2];
extern H265_SPS_Data _rH265SPS[2][32];
extern H265_PPS_Data _rH265PPS[2][256];
extern H265_Slice_Hdr_Data _rH265SliceHdr[2];
extern H265_SEI_Data _rH265SEI[2];
extern VDEC_INFO_H265_PIC_INFO_T _rH265PicInfo[2];
// H265 Struct
