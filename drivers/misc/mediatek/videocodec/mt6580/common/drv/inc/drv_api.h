...
extern VAL_VCODEC_HW_LOCK_T grVcodecHWLock;	/* mutex : HWLock */
...
extern VAL_INT32_T gu4VDecIRQCount;	/* no lock, just for debug */
extern VAL_INT32_T gu4VEncIRQCount;	/* no lock, just for debug */
