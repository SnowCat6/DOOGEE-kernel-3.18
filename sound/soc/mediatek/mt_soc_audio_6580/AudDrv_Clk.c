...
void AudDrv_Clk_On(void)
{
    ...
    if (Aud_AFE_Clk_cntr == 0)
    {
        ...
        {
            printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUDIO_SW_CG fail !!!\n");
        }

        //printk("is MT_CG_AUDIO_SW_CG on:%x, AUDIO_TOP_CON0=%x \n",clock_is_on(MT_CG_AUDIO_SW_CG), Afe_Get_Reg(AUDIO_TOP_CON0));
        
        if (enable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
        {
            printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
        }

        //printk("is MT_CG_AUD_PDN_AFE_EN on:%x, AUDIO_TOP_CON0=%x \n",clock_is_on(MT_CG_AUD_PDN_AFE_EN), Afe_Get_Reg(AUDIO_TOP_CON0));
        
        if (enable_clock(MT_CG_AUD_PDN_DAC_EN, "AUDIO"))
        {
            printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUD_PDN_DAC_EN fail !!!\n");
        }
...
void AudDrv_Clk_Off(void)
{
    ...
    if (Aud_AFE_Clk_cntr == 0)
    {
        printk("------------AudDrv_Clk_Off, Aud_AFE_Clk_cntr:%d \n", Aud_AFE_Clk_cntr);
        {
            ...
            {
                printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUD_PDN_AFE_EN fail");
            }
            //printk("AudDrv_Clk_Off is MT_CG_AUD_PDN_AFE_EN on:%x, AUDIO_TOP_CON0=%x  \n",clock_is_on(MT_CG_AUD_PDN_AFE_EN),Afe_Get_Reg(AUDIO_TOP_CON0));
            
            if (disable_clock(MT_CG_AUD_PDN_DAC_EN, "AUDIO"))
            {
                printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUD_PDN_DAC_EN fail");
            }

            //printk("AudDrv_Clk_Off is MT_CG_AUD_PDN_DAC_EN on:%x, AUDIO_TOP_CON0=%x  \n",clock_is_on(MT_CG_AUD_PDN_DAC_EN),Afe_Get_Reg(AUDIO_TOP_CON0));
            //for Infra power
            if (disable_clock(MT_CG_AUDIO_SW_CG, "AUDIO"))
            {
                printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUDIO_SW_CG fail !!!\n");
            }
...
void AudDrv_ADC_Clk_On(void)
{
    ...
    if (Aud_ADC_Clk_cntr == 0)
    {
        ...
        {
            printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
        }
...
void AudDrv_ADC_Clk_Off(void)
{
    ...
    if (Aud_ADC_Clk_cntr == 0)
    {
        ...
        {
            printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUD_PDN_ADC_EN fail");
        }
...
void AudDrv_Core_Clk_On(void)
{
    ...
    if (Aud_Core_Clk_cntr == 0)
    {
        ...
        if (enable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
        {
            PRINTK_AUD_ERROR("AudDrv_Core_Clk_On Aud enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
        }
#endif
    }
    Aud_Core_Clk_cntr++;
...
void AudDrv_Core_Clk_Off(void)
{
    ...
    if (Aud_Core_Clk_cntr == 0)
    {
        ...
        if (disable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
        {
            PRINTK_AUD_ERROR("AudDrv_Core_Clk_On Aud disable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
        }
#endif
    }
    PRINTK_AUD_CLK("-AudDrv_Core_Clk_On, Aud_Core_Clk_cntr:%d \n", Aud_Core_Clk_cntr);
...
void AudDrv_Suspend_Clk_Off(void)
{
    unsigned long flags;
    spin_lock_irqsave(&auddrv_Clk_lock, flags);
    PRINTK_AUD_CLK("+AudDrv_Suspend_Clk_Off, Aud_Core_Clk_cntr:%d, Aud_AFE_Clk_cntr:%d, Aud_I2S_Clk_cntr:%d, Aud_ADC_Clk_cntr:%d \n",
    ...
    if (Aud_Core_Clk_cntr > 0)
    {
        ...
        if (Aud_AFE_Clk_cntr  > 0)
        {
            if (disable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
            {
                printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_Off enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
            }
        }
        if (Aud_I2S_Clk_cntr > 0)
        {
            if (disable_clock(MT_CG_AUD_PDN_I2S_EN, "AUDIO"))
            {
                PRINTK_AUD_ERROR("AudDrv_Suspend_Clk_Off disable_clock MT_CG_AUD_PDN_I2S_EN fail");
            }
        }
        if (Aud_ADC_Clk_cntr > 0)
        {
            if (disable_clock(MT_CG_AUD_PDN_ADC_EN, "AUDIO"))
            {
                printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_Off enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
            }
            //Afe_Set_Reg(AUDIO_TOP_CON0, 1 << 24 , 1 << 24);
        }
        if (Aud_ADC2_Clk_cntr > 0)
...
void AudDrv_Suspend_Clk_On(void)
{
    unsigned long flags;
    spin_lock_irqsave(&auddrv_Clk_lock, flags);
    PRINTK_AUD_CLK("+AudDrv_Suspend_Clk_On, Aud_Core_Clk_cntr:%d, Aud_AFE_Clk_cntr:%d, Aud_I2S_Clk_cntr:%d, Aud_ADC_Clk_cntr:%d \n",
    Aud_Core_Clk_cntr,Aud_AFE_Clk_cntr,Aud_I2S_Clk_cntr,Aud_ADC_Clk_cntr);
    AudDrv_Clk_Reset();
    if (Aud_Core_Clk_cntr > 0)
    {
        ...
        if (Aud_AFE_Clk_cntr  > 0)
        {
            if (enable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
            {
                printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_On enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
            }
        }
        if (Aud_I2S_Clk_cntr > 0)
        {
            if (enable_clock(MT_CG_AUD_PDN_I2S_EN, "AUDIO"))
            {
                PRINTK_AUD_ERROR("AudDrv_Suspend_Clk_On enable_clock MT_CG_AUD_PDN_I2S_EN fail");
            }
        }
        if (Aud_ADC_Clk_cntr > 0)
        {
            if (enable_clock(MT_CG_AUD_PDN_ADC_EN, "AUDIO"))
            {
                printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_On enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
            }
            //Afe_Set_Reg(AUDIO_TOP_CON0, 0 << 24 , 1 << 24);
        }
        if (Aud_ADC2_Clk_cntr > 0)
...
void AudDrv_Clk_Reset(void)
{
    ...
    if (enable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
    {
        printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Clk_Reset enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
    }
    if (enable_clock(MT_CG_AUD_PDN_I2S_EN, "AUDIO"))
    {
    ...
    if (enable_clock(MT_CG_AUD_PDN_ADC_EN, "AUDIO"))
    {
        printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Clk_Reset enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
    }
    if (enable_clock(MT_CG_AUD_PDN_DAC_EN, "AUDIO"))
    {
        printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Clk_Reset enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
    ...
    if (disable_clock(MT_CG_AUD_PDN_DAC_EN, "AUDIO"))
    {
        printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Clk_Reset enable_clock MT_CG_AUD_PDN_DAC_EN fail !!!\n");
    }
    if (disable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
    {
        printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Clk_Reset enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
