...
bool InitAfeControl(void)
{
    ...
    //Auddrv_Read_Efuse_HPOffset(); //Todo Sam
...
bool SetSampleRate(uint32 Aud_block, uint32 SampleRate)
{
    ...
    switch (Aud_block)
    {
        ...
        {
#if 0   //Sammodi 82 no, but might need it on Rainier        
...
#if 0   //Sammodi 82 no  low jitter mode, but need to check it on Rainier
