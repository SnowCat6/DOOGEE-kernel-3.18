...
uint32  SetCLkHdmiBclk(uint32 MckDiv, uint32 SampleRate, uint32 Channels , uint32 bitDepth)
{
    ...
    I2s_Bck_div = (I2S_APll / MckDiv) / I2S_Bclk - 1;
...
void SetHdmiPcmInterConnection(unsigned int connection_state, unsigned int channels)
{
	...
	switch (channels) {
	case 8:
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I36, Soc_Aud_InterConnectionOutput_O36);
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I37, Soc_Aud_InterConnectionOutput_O37);
	case 6:
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I34, Soc_Aud_InterConnectionOutput_O32);
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I35, Soc_Aud_InterConnectionOutput_O33);
	case 4:
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I32, Soc_Aud_InterConnectionOutput_O34);
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I33, Soc_Aud_InterConnectionOutput_O35);
	case 2:
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I30, Soc_Aud_InterConnectionOutput_O30);
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I31, Soc_Aud_InterConnectionOutput_O31);
		break;
	case 1:
		Afe_Set_Reg(connection_state, Soc_Aud_InterConnectionInput_I30, Soc_Aud_InterConnectionOutput_O30);
		break;
